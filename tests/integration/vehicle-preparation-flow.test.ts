...
import type { VehicleDraft } from "../../src/modules/vehicles/types.js";

function criarVehicleDraft(overrides: Partial<VehicleDraft> = {}): VehicleDraft {
  return {
    plate: " qad-1f23 ",
...
function criarChecklistItem(overrides: Partial<ChecklistItem>): ChecklistItem {
  return {
    id: "item-1",
    vehicle_id: 1,
    title: "Tarefa",
